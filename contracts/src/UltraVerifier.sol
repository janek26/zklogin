                0x04bf914031bd405440af705425e95109b8ccb07be5f521baf78522a47f808aef
            ) // vk.TABLE3.y
            mstore(
                add(_vk, 0x4c0),
                0x17841405ffd5b7391dfc4c67df8b83b829c04c6c39fa304c63ba85efc356cb6b
            ) // vk.TABLE4.x
            mstore(
                add(_vk, 0x4e0),
                0x071662508f56a08c39f23e3b574939b610830931daaf5f8c7da09d8341423e72
            ) // vk.TABLE4.y
            mstore(
                add(_vk, 0x500),
                0x2cd0adb4efab7c1f2f3ce467113f6b5a60ab824b86852c995d83e87af264bd71
            ) // vk.TABLE_TYPE.x
            mstore(
                add(_vk, 0x520),
                0x0c6a58624d7220202551ec32fe8abdd14f9830dc08578941185a66282cb04948
            ) // vk.TABLE_TYPE.y
            mstore(
                add(_vk, 0x540),
                0x13f7aa6c469715e6cd1f38bf20c9b09078403df8217f9d30df97aae41d460f40
            ) // vk.ID1.x
            mstore(
                add(_vk, 0x560),
                0x02944c0148d257c53e52d2ea61b6fcfedf6dc6861d4833893f5b2f367e68232f
            ) // vk.ID1.y
            mstore(
                add(_vk, 0x580),
                0x0737ea2401dff83ecc5d6258aec1533b305e85a418c2a8c2fbec7bf6fbc39599
            ) // vk.ID2.x
            mstore(
                add(_vk, 0x5a0),
                0x108fb619aec96784857cd68447c8455790602ef51e7e6e4c7cdc416831a9ab50
            ) // vk.ID2.y
            mstore(
                add(_vk, 0x5c0),
                0x1064d92338c133f3c77d13a7d4d688f94216dca3143f8ff96aa5b9530295cc97
            ) // vk.ID3.x
            mstore(
                add(_vk, 0x5e0),
                0x2336336f949cb51eab3edeb98bbeeb7aecd353fda918c1ee5aea9d01f1e2b446
            ) // vk.ID3.y
            mstore(
                add(_vk, 0x600),
                0x1beb44efe9150760b8b668dd41a5229e21258845fb446004f5b5501ba4a6495c
            ) // vk.ID4.x
            mstore(
                add(_vk, 0x620),
                0x1c7187e828b8c1ef699c55a031ca21baeea080a8f70a7e41b41ea35eff4ffeb0
            ) // vk.ID4.y
...
abstract contract BaseUltraVerifier {
     ...
     */
    function loadVerificationKey(uint256 _vk, uint256 _omegaInverseLoc)
        internal
        pure
        virtual;
        ...
        returns (bool)
    {
        ...
        if (requiredPublicInputCount != _publicInputs.length) {
            revert PUBLIC_INPUT_COUNT_INVALID(
                requiredPublicInputCount, _publicInputs.length
            );
        }
        ...
        assembly {
             ...
             */
            {
                if mload(CONTAINS_RECURSIVE_PROOF_LOC) {
                    ...
                    if iszero(
                        and(and(lt(x0, q), lt(x1, q)), and(lt(y0, q), lt(y1, q)))
                    ) {
...

            {
                ...
                let challenge_bytes_size :=
                    add(0x20, add(public_input_size, ETA_INPUT_LENGTH))
             ...
             */
            {
                ...
                let endpoint_ptr :=
                    add(public_inputs_ptr, mul(mload(NUM_INPUTS_LOC), 0x20))
            ...
            {
                let delta_base :=
                    mulmod(mload(C_GAMMA_LOC), addmod(mload(C_BETA_LOC), 1, p), p)
             ...
             */
            {
                ...
                let identity :=
                    addmod(
                        ...
                        addmod(
                            w4q3,
                            addmod(w3q3, addmod(w2q2, addmod(w1q1, w1w2qm, p), p), p),
                            p
                        ),
                        p
                    )
             ...
             */
            {
                ...
                let d4 :=
                    addmod(mload(W1_OMEGA_EVAL_LOC), sub(p, mload(W4_EVAL_LOC)), p)
             ...
             */
            {
                    ...
                    let non_native_field_gate_1 :=
                        mulmod(
                            addmod(
                                ...
                                sub(
                                    p,
                                    addmod(mload(W3_EVAL_LOC), mload(W4_EVAL_LOC), p)
                                ),
                                p
                            ),
                            mload(Q3_EVAL_LOC),
...

                {
                    ...
                    let memory_record_check :=
                        mulmod(mload(W3_EVAL_LOC), mload(C_ETA_LOC), p)
                    ...
                    let index_delta :=
                        addmod(mload(W1_OMEGA_EVAL_LOC), sub(p, mload(W1_EVAL_LOC)), p)
                    // record_delta = w_4_omega - w_4
                    let record_delta :=
                        addmod(mload(W4_OMEGA_EVAL_LOC), sub(p, mload(W4_EVAL_LOC)), p)
...

                    {
                        ...
                        let access_type :=
                            addmod(mload(W4_EVAL_LOC), sub(p, partial_record_check), p)
                        let access_check :=
             ...
             */
            {
                ...
                let challenge :=
                    keccak256(NU_CHALLENGE_INPUT_LOC_A, add(NU_INPUT_LENGTH, 0x40))
